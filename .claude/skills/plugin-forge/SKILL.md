---
name: plugin-forge
description: Create and manage Claude Code plugins with proper structure, manifests, and marketplace integration. Used by @scout-sprint as the backbone for execute_antigravity_scaffold — generates boilerplate for agents/, skills/, and commands/ directories using ohmyclaude conventions. Triggers on "scaffold", "boilerplate", "generate plugin", "new agent template".
---
