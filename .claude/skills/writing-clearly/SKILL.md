...
description: Apply Strunk's rules for clearer, stronger writing. Used by @dora-docs (changelogs, READMEs), @evan-evangelist (announcements), and @paige-product (PRDs, UX specs). Triggers when writing any human-readable prose — documentation, commit messages, error messages, reports, or UI text.
---
