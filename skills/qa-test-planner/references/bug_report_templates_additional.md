# Bug Report Templates — Additional Formats

This file continues [bug_report_templates.md](bug_report_templates.md) with Quick, UI, Performance, Security, and Crash bug templates plus the severity/priority matrix. For the full Standard template, see the main file.
...
See also: [bug_report_templates.md](bug_report_templates.md) for the full Standard template.
