...
description: Create API handoff documentation for @effie-frontend to consume. Used by @beck-backend after completing an API implementation in the ohmyclaude pipeline. Output saved to .claude/pipeline/. Triggers on 'create handoff', 'document API', 'frontend handoff', 'API documentation'.
---
