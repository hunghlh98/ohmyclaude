...
description: Guide technical communication for software developers, including announcement writing for releases. Used by @evan-evangelist when drafting ANNOUNCEMENT-<id>.md — outputs three formats: Tweet (≤280 chars), GitHub Discussion (3 paragraphs), Newsletter. Also covers email, team messaging, and meeting agendas. Triggers on "announcement", "release post", "draft message", "communication".
