...
description: Document frontend data needs for @beck-backend to implement. Used by @effie-frontend before starting UI implementation to specify data requirements without prescribing implementation. Triggers on 'backend requirements', 'what data do I need', 'API requirements'.
---
