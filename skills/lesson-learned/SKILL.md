---
name: lesson-learned
description: "Analyze recent code changes via git history and extract software engineering lessons. Used by @dora-docs as a 'Contextual Why' layer in changelogs — captures the reasoning behind changes, not just what changed. Triggers on 'what is the lesson here?', 'engineering takeaway', 'reflect on this code', or when generating changelog entries for a completed feature."
---
